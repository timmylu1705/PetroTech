...
namespace PetroTech.Data.Infastructure
{
    public abstract class Repository<T> : IRepository<T> where T : class
    {
        ...
        protected PetroDbContext PetroDbContext
        {
        ...
        {
            dbSet.Attach(entity);
            petroDbContext.Entry(entity).State = EntityState.Modified;
        }
        ...
        public IQueryable<T> GetAll(string[] includes = null)
        {
            ...
            {
                var query = petroDbContext.Set<T>().Include(includes.First());
            ...
            return petroDbContext.Set<T>().AsQueryable();
        }
        ...
        public virtual IQueryable<T> GetMulti(Expression<Func<T, bool>> predicate, string[] includes = null)
        {
            ...
            return petroDbContext.Set<T>().Where<T>(predicate).AsQueryable<T>();
        }
        ...
        public virtual IQueryable<T> GetMultiPaging(Expression<Func<T, bool>> predicate, out int total, int index = 0, int size = 20, string[] includes = null)
        {
            ...
            {
                _resetSet = predicate != null ? petroDbContext.Set<T>().Where<T>(predicate).AsQueryable() : petroDbContext.Set<T>().AsQueryable();
            }
        ...
        {
            return petroDbContext.Set<T>().Count<T>(predicate) > 0;
        }
